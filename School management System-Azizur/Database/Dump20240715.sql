...
INSERT INTO `admissionform` VALUES (1002,'Hasan Mahmud','2001-05-20','hasu1@gmail.com','4545454','male','Arbaz khan','Arobi Khan','Two','Business Studies','qsqs','qsqs','ee','Hasan12112','2ww','assets\\images\\Chairman_2023.jpg');
...
CREATE TABLE `fee_management` (
  `fee_management_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `fee_management` VALUES (1,'Registration Fee',2000,102,'9th','2024-06-02','2024-06-25',0,NULL),(2,'Registration Fee',2000,107,'9th','2024-06-02','2024-06-25',0,NULL),(11,'Monthly Fee',1111,101,'5th','2024-06-16','2024-07-06',0,'May - 2024'),(12,'Monthly Fee',1111,106,'5th','2024-06-16','2024-07-06',0,'May - 2024');
...
CREATE TABLE `payment_records` (
  ...
  `class` varchar(45) DEFAULT NULL,
  `fee_management_id` int(11) DEFAULT NULL,
...
INSERT INTO `payment_records` VALUES (1,'101',2000,'2024-05-02','Bank Transfer','Rejected','a1','5th',11,'ae','bw','cw');
...
-- Dump completed on 2024-07-15 10:10:36
