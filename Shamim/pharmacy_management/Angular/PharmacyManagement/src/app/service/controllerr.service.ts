...
//save all supplier 
  ...
  //==================================Damage=================================
  updateDamege(a:any):Observable<any>{
    this.url="http://localhost:8080/update-damage";
    return this.http.put<any>(this.url,a);
  }
  ...
  getExpiredList():Observable<any>{
    this.url="http://localhost:8080/get-expired";
    return this.http.get<any>(this.url);
  }

  //==================================updateExpaireList=================================
  updateExpaireList(a:any):Observable<any>{
    this.url="http://localhost:8080/update-expired";
    return this.http.put<any>(this.url,a);
  }
...
//===========save Transaction======
saveTransaction(t:any):Observable<any>{
  this.url="http://localhost:8080/save-transaction";
  return this.http.post<any>(this.url,t);
}

//get Transaction report by date====================
getTransection(ds:any,de:any):Observable<any>{
  this.url="http://localhost:8080/get-transaction/"+ds+"/"+de;
  return this.http.get<any>(this.url);
}
...
getAccountsDetails():Observable<any>{
  this.url="http://localhost:8080/get-accounts";
  return this.http.get<any>(this.url);
}
